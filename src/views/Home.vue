                ...
                <el-col :span="7" class="userinfo">
                    <el-dropdown trigger="click">
                        ...
                        <el-dropdown-menu slot="dropdown">
                            <el-dropdown-item v-for="(item,index) in shopList" :key="index" @click.native="changeShop(index)"><img :src="UPLOADURL + '/shopLogo/' + shopId + '.png/shopLogo.png'" alt="" width="30" height="30">{{item.shopName}}</el-dropdown-item>
